...
class BuyerProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create buyer_product" do
    assert_difference('BuyerProduct.count') do
      post buyer_products_url, params: { buyer_product: { product_id: @buyer_product.product_id, user_id: @buyer_product.user_id } }
    end
  ...
  test "should update buyer_product" do
    patch buyer_product_url(@buyer_product), params: { buyer_product: { product_id: @buyer_product.product_id, user_id: @buyer_product.user_id } }
